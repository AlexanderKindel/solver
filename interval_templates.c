...
char*interval_get_max_magnitude_template =
"struct %00*%01_interval_get_max_magnitude(struct Stack*output_stack, struct Stack*local_stack, struct %00Interval*a)\n"
"{\n"
"    void*local_stack_savepoint = local_stack->cursor;\n"
"    void*out = %01_get_max(output_stack, local_stack, %01_get_magnitude(local_stack, a->min), %01_get_magnitude(local_stack, a->max));\n"
...
char*interval_negate_template =
"struct %00Interval*%01_interval_negate(struct Stack*output_stack, struct Stack*local_stack, struct %00Interval*a)\n"
"{\n"
"    struct %00Interval*out = ALLOCATE(output_stack, struct %00Interval);\n"
"    if (%01_get_sign(a->min) != -%01_get_sign(a->max))\n"
"    {\n"
"        out->min = %01_negate(output_stack, a->max);\n"
"        out->max = %01_negate(output_stack, a->min);\n"
"    }\n"
"    else\n"
"    {\n"
"        void*local_stack_savepoint = local_stack->cursor;\n"
"        out->min = %01_copy(output_stack, %01_get_min(output_stack, local_stack, %01_negate(local_stack, a->max), a->min));\n"
"        out->max = %01_copy(output_stack, %01_get_max(output_stack, local_stack, %01_negate(local_stack, a->min), a->max));\n"
"        local_stack->cursor = local_stack_savepoint;\n"
"    }\n"
"    return out;\n"
"}\n";
...
"{\n"
"    struct %00Interval*out = ALLOCATE(output_stack, struct %00Interval);\n"
"    if (%01_get_sign(a->min) >= 0)\n"
"    {\n"
"        if (%01_get_sign(b->min) >= 0)\n"
"        {\n"
...
"        {\n"
"            void*local_stack_savepoint = local_stack->cursor;\n"
"            out->min = %01_copy(output_stack, %01_get_min(output_stack, local_stack,\n"
"                %01_multiply(local_stack, output_stack, a->min, b->max),\n"
"                %01_multiply(local_stack, output_stack, a->max, b->min)));\n"
"            out->max = %01_copy(output_stack, %01_get_max(output_stack, local_stack,\n"
