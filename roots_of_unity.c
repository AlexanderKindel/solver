    ...
    struct NestedPolynomial*outer_annulling_polynomial)
{
    ...
    struct NestedPolynomial*out = nested_polynomial_get_remainder(output_stack, local_stack,
        number_field_polynomial_multiply(local_stack, output_stack, a, b,
            inner_annulling_polynomial),
        outer_annulling_polynomial);
    ...
    struct Stack*restrict local_stack_b, struct Integer*degree)
{
    ...
    generator_not_found:
        ...
        {
            if (integer_equals(integer_get_remainder(local_stack_a, local_stack_b,
    ...
    struct RationalPolynomial*n_minus_first_root_annulling_polynomial =
        polynomial_allocate(local_stack_a, degree_size_t);
    ...
    struct NestedPolynomial*nth_root_annulling_polynomial =
        polynomial_allocate(local_stack_a, degree_size_t + 1);
    nth_root_annulling_polynomial->coefficients[0] = polynomial_allocate(local_stack_a, 1);
    ...
    resolvents[0] = polynomial_allocate(local_stack_a, 2);
    ...
    {
        generator_power = integer_get_remainder(local_stack_a, local_stack_b,
            integer_multiply(local_stack_a, local_stack_b, generator_power, generator), degree);
        ...
        for (size_t j = 0; j < resolvent_count; ++j)
        {
            ...
            struct NestedPolynomial*resolvent_term =
                polynomial_allocate(local_stack_a, generator_power_size_t + 1);
    ...
    struct Rational*degree_minus_one_reciprocal = ALLOCATE(local_stack_a, struct Rational);
